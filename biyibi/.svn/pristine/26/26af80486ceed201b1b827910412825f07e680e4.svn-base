...
{
	NSLog(@"** [UIColor colorFromHex:withAlpha:] is now deprecated, please use [UIColor colorWithHexString:] instead.");
...
/// Same logic as +[UIColor colorWithRGBHex:], but intializes a retained UIColor rather than autoreleased.
/// 
