	...
	class ISC_ADMIN_PAGES
	{
		...
		private function AddPageStep1($MsgDesc = "", $MsgStatus = "", $IsError = false)
		{
			...
			if($IsError) {
				...
				$GLOBALS['controlscript'] = isc_html_escape($arrData['controlscript']);
				$GLOBALS['trackingscript'] = isc_html_escape($arrData['trackingscript']);
...
//blessen
				$newPage = array(
					...
					"controlscript" => $Data['controlscript'],
