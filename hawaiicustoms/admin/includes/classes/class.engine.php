<?php
	...
	class ISC_ADMIN_ENGINE
	{
				...
				$menuItems = array(
					...
					'mnuTools' => array(
						...
						'items' => array(
                            ...
                            array(
                                'link' => 'index.php?ToDo=manageSitemap',
                                'text' => GetLang('ManageSitemap'),
                                'show' => in_array(AUTH_System_Info, $arrPermissions) && !GetConfig('DisableSystemInfo')
                            )
						)
					),
					'mnuSettings' => array(
						...
						'items' => array(
							...
							//zcs=>image uploader
							array(
								'link' => 'index.php?ToDo=viewImageUploaderSettings',
								'text' => GetLang('ImageUploaderSettings')
							),
							//<=zcs
							array(
							...
							//zfang_20100629 Added for the new pages settings.order.reviewrequest.manage.tpl
							//and class.settings.order.reviewrequest.php
							array(
								'link' => 'index.php?ToDo=viewRequestScriptSettings',
								//Todo: Change to GetLang
								'text' => 'Order Review Request Settings',
								//'text' => GetLang('OrderReviewRequestSettings'),
								'show' => gzte11(ISC_MEDIUMPRINT)
							),
							...
							array(
								'link' => 'index.php?ToDo=viewCompanyGiftCertificateSettings',
								'text' => GetLang('CompanyGiftCertificateSettings'),
								'show' => gzte11(ISC_LARGEPRINT)
							),
							array(
							...
							array(
								'link' => 'index.php?ToDo=viewCustomerServiceSettings',
								'text' => GetLang('CustomerServiceSettings')
							),
							array(
                            ...
                            array(
                                'link' => 'index.php?ToDo=viewRedirectSettings',
                                'text' => GetLang('RedirectSettings'),
                            )
						)
					),
					'mnuLogout' => array(
		...
		*/
		...
		{
            $current_user = $GLOBALS['ISC_CLASS_ADMIN_AUTH']->GetUser();
            $current_user_name = empty($current_user['username'])?'':$current_user['username'];
            $show_ymm_update_option = in_array($current_user_name, array('dev1', 'nirvana'));
			$menu = "";
			...
			$menuItems = array (
				'mnuOrders' => array (
					...
					'items' => array(
						...
						array (
							'text' => GetLang('ViewOffers'),
							'help' => GetLang('ViewOffersMenuHelp'),
							'icon' => 'order.gif',
							'link' => 'index.php?ToDo=viewOffers',
							'show' => $show_manage_orders,
						),
						array (
				...
				'mnuCustomers' => array (
					...
					'items' => array(
						...
						//zcs=>
						array (
							'text' => GetLang('ViewUploadedPhotos'),
							'help' => GetLang('ViewUploadedPhotosHelp'),
							'icon' => 'customer.gif',
							'link' => 'index.php?ToDo=viewCustomerPhotos',
							'show' => $show_manage_customers,
						),
						//<=zcs
						array (
				...
				'mnuProducts' => array (
					...
					'items' => array(
						array (
							'text' => GetLang('UpdateProductYmmCacheFile'),
							'help' => GetLang('UpdateProductYmmCacheFileMenuHelp'),
							'icon' => 'product.gif',
							'link' => 'index.php?ToDo=updateproductymmcachedata',
							'show' => $show_ymm_update_option,
						),
						array (
							'text' => GetLang('UpdateCategoryBrandCacheFile'),
							'help' => GetLang('UpdateCategoryBrandCacheFileMenuHelp'),
							'icon' => 'product.gif',
							'link' => 'index.php?ToDo=updateproduct_categorybrandcachedata',
							'show' => $show_ymm_update_option,
						),
						array (
						...
						array (
							'text' => GetLang('AddonProducts'),
							'help' => GetLang('ViewAddonProductsMenuHelp'),
							'icon' => 'product.gif',
							'link' => 'index.php?ToDo=viewAddonProducts',
							'show' => $show_manage_products,
						),
						array (
						...
						array (
							'text' => GetLang('ProductKeywords'),
							'help' => GetLang('ProductKeywordsHelp'),
							'icon' => 'product_variation.gif',
							'link' => 'index.php?ToDo=prodKeywords',
							'show' => $show_manage_products,
						),
						array (
				...
				'mnuContent' => array (
					...
					'items' => array(
						...
						array (
							'text' => GetLang('CreateABTesingPage'),
							'help' => GetLang('CreateABTestingPageMenuHelp'),
							'icon' => 'page_add.gif',
							'link' => 'index.php?ToDo=viewABTesting',
							'show' => in_array(AUTH_Manage_Pages, $arrPermissions),
						),
					),
				),
				'mnuPromotions' => array (
					...
					'items' => array(
						...
						//NI Cloud 2010-06-24
						//add pop-up menu item for company gift certificate
						array (
							'text' => GetLang('ViewCompanyGiftCertificates'),
							'help' => GetLang('ViewCompanyGiftCertificatesMenuHelp'),
							'icon' => 'giftcertificate.gif',
							'link' => 'index.php?ToDo=viewCompanyGiftCertificates',
							'show' => in_array(AUTH_Manage_Company_GiftCertificates, $arrPermissions),

						),
						array (
                            'text' => GetLang('ViewSweepstakes'),
                            'help' => GetLang('ViewSweepstakesHelp'),
                            'icon' => 'discountrule.gif',
                            'link' => 'index.php?ToDo=viewSweepstakes',
                            'show' => in_array(AUTH_Manage_Discounts, $arrPermissions) && gzte11(ISC_MEDIUMPRINT),
                        ),
						array (
				...
				'mnuStatistics' => array (
					...
					'items' => array(
						...
						array ( # Added by Mayank Jaitly on 14 July 2010
							'text' => "Sales Statistics",
							'help' => "See the sales statistic of users.",
							'icon' => 'stats_search.gif',
							'link' => 'index.php?ToDo=viewSalesStats',
							'show' => in_array(AUTH_Statistics_Search, $arrPermissions),
						),
					),
				),
