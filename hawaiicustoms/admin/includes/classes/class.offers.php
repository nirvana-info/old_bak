	...
	class ISC_ADMIN_OFFERS
	{
		...
		public function HandleToDo($Do)
		{
			...
			$GLOBALS['BreadcrumEntries'] = array(
				...
				GetLang('Offers') => 'index.php?ToDo=viewOffers'
			);
			...
			switch (isc_strtolower($Do))
			{
				case 'saveneworder':
					$this->SaveNewOrder();
					break;
				case 'saveupdatedoffer':
					$this->SaveUpdatedOffer();
					break;
				case "addorder":
					$this->AddOrder();
					break;
				...
				case "saveupdatedordermessage":
					...
					if ($GLOBALS['ISC_CLASS_ADMIN_AUTH']->HasPermission(AUTH_Order_Messages)) {
						...
						$GLOBALS['BreadcrumEntries'] = array(GetLang('Home') => "index.php", GetLang('Offers') => "index.php?ToDo=viewOffers", GetLang('ViewMessages') => "index.php?ToDo=saveUpdatedOrderMessage");
					...
					break;
				case "editoffermessage":
					if(!gzte11(ISC_LARGEPRINT)) {
						exit;
					}
					if ($GLOBALS['ISC_CLASS_ADMIN_AUTH']->HasPermission(AUTH_Order_Messages)) {

						$GLOBALS['BreadcrumEntries'] = array(GetLang('Home') => "index.php", GetLang('Offers') => "index.php?ToDo=viewOffers", GetLang('ViewMessages') => "index.php?ToDo=viewOfferMessages&orderId=" . @(int)$_GET['orderId'], GetLang('EditMessage') => "index.php?ToDo=editOrderMessage");

						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->PrintHeader();
						$this->EditOfferMessage();
						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->PrintFooter();
					} else {
						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->DoHomePage(GetLang('Unauthorized'), MSG_ERROR);
					}
					break;
				case "savenewoffermessage":
					if(!gzte11(ISC_LARGEPRINT)) {
						exit;
					}
					if ($GLOBALS['ISC_CLASS_ADMIN_AUTH']->HasPermission(AUTH_Order_Messages)) {
						...
						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->PrintHeader();
						$this->SaveNewOfferMessage();
						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->PrintFooter();
					} else {
						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->DoHomePage(GetLang('Unauthorized'), MSG_ERROR);
					}
					break;
				case "createoffermessage":
					if(!gzte11(ISC_LARGEPRINT)) {
						exit;
					}
					if ($GLOBALS['ISC_CLASS_ADMIN_AUTH']->HasPermission(AUTH_Order_Messages)) {

						$GLOBALS['BreadcrumEntries'] = array(GetLang('Home') => "index.php", GetLang('Offers') => "index.php?ToDo=viewOffers", GetLang('ViewofferMessages') => "index.php?ToDo=viewOfferMessages&orderId=" . @(int)$_GET['orderId'], GetLang('CreateMessage') => "index.php?ToDo=createOrderMessage");
					...
					break;
				case "deleteoffermessages":
					if(!gzte11(ISC_LARGEPRINT)) {
						exit;
					}
					if ($GLOBALS['ISC_CLASS_ADMIN_AUTH']->HasPermission(AUTH_Order_Messages)) {

						$GLOBALS['BreadcrumEntries'] = array(GetLang('Home') => "index.php", GetLang('Offers') => "index.php?ToDo=viewOffers", GetLang('ViewofferMessages') => "index.php?ToDo=saveUpdatedOfferMessage");

						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->PrintHeader();
						$this->DeleteOfferMessages();
						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->PrintFooter();
					} else {
						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->DoHomePage(GetLang('Unauthorized'), MSG_ERROR);
					}
					break;
				case "flagoffermessage":
					if(!gzte11(ISC_LARGEPRINT)) {
						exit;
					}
					if ($GLOBALS['ISC_CLASS_ADMIN_AUTH']->HasPermission(AUTH_Order_Messages)) {

						$GLOBALS['BreadcrumEntries'] = array(GetLang('Home') => "index.php", GetLang('Offers') => "index.php?ToDo=viewOffers", GetLang('ViewMessages') => "index.php?ToDo=viewOfferMessages");

						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->PrintHeader();
						$this->FlagOfferMessage();
						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->PrintFooter();
					} else {
						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->DoHomePage(GetLang('Unauthorized'), MSG_ERROR);
					}
				...
				case "updateordermessagestatus":
					...
					if ($GLOBALS['ISC_CLASS_ADMIN_AUTH']->HasPermission(AUTH_Order_Messages)) {
						...
						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->PrintHeader();
						$this->UpdateOfferMessageStatus();
						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->PrintFooter();
					} else {
						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->DoHomePage(GetLang('Unauthorized'), MSG_ERROR);
					}
					break;
				case "viewoffermessages":
					if(!gzte11(ISC_LARGEPRINT)) {
						exit;
					}
					if ($GLOBALS['ISC_CLASS_ADMIN_AUTH']->HasPermission(AUTH_Order_Messages)) {

						$GLOBALS['BreadcrumEntries'] = array(GetLang('Home') => "index.php", GetLang('Offers') => "index.php?ToDo=viewOffers", GetLang('ViewofferMessages') => "index.php?ToDo=viewOfferMessages");

						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->PrintHeader();
						$this->ViewOfferMessages();
						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->PrintFooter();
					} else {
						$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->DoHomePage(GetLang('Unauthorized'), MSG_ERROR);
					}
				...
				case "deleteoffers":
					if ($GLOBALS['ISC_CLASS_ADMIN_AUTH']->HasPermission(AUTH_Delete_Orders)) {
						...
						$GLOBALS['BreadcrumEntries'] = array(GetLang('Home') => "index.php", GetLang('Offers') => "index.php?ToDo=viewOffers");
				...
				default:
					if ($GLOBALS['ISC_CLASS_ADMIN_AUTH']->HasPermission(AUTH_Manage_Orders)) {
						...
						if(isset($_GET['searchQuery'])) {
							$GLOBALS['BreadcrumEntries'] = array(GetLang('Home') => "index.php", GetLang('Offers') => "index.php?ToDo=viewOffers", GetLang('SearchResults') => "index.php?ToDo=viewOffers");
						}
						else {
							$GLOBALS['BreadcrumEntries'] = array(GetLang('Home') => "index.php", GetLang('Offers') => "index.php?ToDo=viewOffers");
						}
		...
		private function DeleteOffers()
		{
			...
			if(isset($_POST['orders'])) {
				...
				$GLOBALS['ISC_CLASS_DB']->DeleteQuery('offer_messages', "WHERE messageorderid IN ('".$orderIds."')");
				$GLOBALS['ISC_CLASS_DB']->DeleteQuery('order_coupons', "WHERE ordcouporderid IN ('".$orderIds."')");
				$GLOBALS['ISC_CLASS_DB']->DeleteQuery('offers', "WHERE orderid IN ('".$orderIds."')");
				

				$err = $GLOBALS['ISC_CLASS_DB']->GetErrorMsg();

				if ($err != "") {
					$this->ManageOffers($err, MSG_ERROR);
				} else {
					...
					$this->ManageOffers(GetLang('OffersDeletedSuccessfully'), MSG_SUCCESS);
				}
			} else {
				if ($GLOBALS['ISC_CLASS_ADMIN_AUTH']->HasPermission(AUTH_Manage_Orders)) {
					$this->ManageOffers();
		...
		private function ManageOffersGrid(&$numOrders)
		{
			...
			if(isset($_REQUEST['sortField']) && in_array($_REQUEST['sortField'], $validSortFields)) {
				...
				SaveDefaultSortField("ManageOffers", $_REQUEST['sortField'], $sortOrder);
			}
			else {
				list($sortField, $sortOrder) = GetDefaultSortField("ManageOffers", "orderid", $sortOrder);
			}
			...
			if($numOrders > ISC_ORDERS_PER_PAGE) {
				...
				$GLOBALS['Nav'] .= BuildPagination($numOrders, ISC_ORDERS_PER_PAGE, $page, sprintf("index.php?ToDo=viewOffers%s", $sortURL));
			}
			else {
				$GLOBALS['Nav'] = "";
			}
			...
			BuildAdminSortingLinks($sortLinks, "index.php?ToDo=viewOffers&amp;".$searchURL."&amp;page=".$page, $sortField, $sortOrder);
			...
			while ($row = $GLOBALS['ISC_CLASS_DB']->Fetch($orderResult)) {
				...
				if($row['ordstatus'] == '0' || $row['ordstatus'] == '13') { # Baskaran
					$GLOBALS['ActionDisable'] = 'disabled="disabled"';
				}
				else {
					$GLOBALS['ActionDisable'] = '';
				}
				...
				if($GLOBALS['ISC_CLASS_ADMIN_AUTH']->HasPermission(AUTH_Order_Messages) && $row['ordcustid'] > 0) {
					...
					$GLOBALS['MessageLink'] = sprintf("<a title='%s' class='Action' href='index.php?ToDo=viewOfferMessages&amp;ord
					erId=%d'>%s %s</a><br />(%s)",
				...
				$GLOBALS['ISC_CLASS_TEMPLATE']->SetTemplate("offers.manage.row");
			...
			$GLOBALS['ISC_CLASS_TEMPLATE']->SetTemplate("offers.manage.grid");
			return $GLOBALS['ISC_CLASS_TEMPLATE']->ParseTemplate(true);
		}

		private function ManageOffers($MsgDesc = "", $MsgStatus = "")
		{
			...
			$GLOBALS['OrderDataGrid'] = $this->ManageOffersGrid($numOrders);
			...
			$GLOBALS['OrderActionOptions'] = '<option value="choose" selected="1">' . GetLang('ChooseAction') . '</option>';
...
//			$GLOBALS['OrderActionOptions'] .= '</optgroup>';
			...
			$GLOBALS['OrderIntro'] = GetLang('ManageOffersIntro');
			$GLOBALS['Message'] = '';
			// No orders
			if($numOrders == 0) {
			...
			$GLOBALS['ISC_CLASS_TEMPLATE']->SetTemplate("offers.manage");
			$GLOBALS['ISC_CLASS_TEMPLATE']->ParseTemplate();
		...
		public function _GetOrderList($Start, $SortField, $SortOrder, &$NumOrders, $AddLimit=true)
		{
			...
			$countQuery = "SELECT COUNT(o.orderid) FROM [|PREFIX|]offers o";
			if (!empty($extraJoins)) {
				$countQuery .= ' '.$extraJoins;
			}

			if(isset($_REQUEST['newMessages'])) {
				$countQuery .= " LEFT JOIN [|PREFIX|]offer_messages ON (messageorderid=orderid) AND messagefrom='customer' AND messagestatus='unread'";
			}
		...
		*/
		public function BuildWhereFromVars($array)
		{
			...
			// Otherwise, only fetch complete orders
				...
				//$queryWhere .= " AND ordstatus > 0";  blessen
		...
		public function GetOrderStatusOptions($SelectedStatus = null)
		{
			...
			if ($statuses === null) {
				$statuses = array();
					...
					$statuses[] = array( # Baskaran
						"statusid" => 0,
						"statusdesc" => "InComplete"
					);
					$statuses[] = array(
						"statusid" => 11,
						"statusdesc" => "Awaiting for Approval"
					);
					$statuses[] = array(
						"statusid" => 12,
						"statusdesc" => "Approved"
...
//			return $output;
		...
		*/
		...
		{
			$messages = array();
			$query = sprintf("select *, (select username from [|PREFIX|]users where pk_userid=staffuserid) as uname, (select userfirstname from [|PREFIX|]users where pk_userid=staffuserid) as ufname, (select userlastname from [|PREFIX|]users where pk_userid=staffuserid) as ulname from [|PREFIX|]offer_messages where messageorderid='%d' order by %s %s", $GLOBALS['ISC_CLASS_DB']->Quote($OrderId), $SortField, $SortOrder);
			$result = $GLOBALS['ISC_CLASS_DB']->Query($query);
			...
			if(defined("IS_IPHONE")) {
				...
				$GLOBALS['ISC_CLASS_DB']->UpdateQuery("offer_messages", $updatedMessage, "messageorderid='".$GLOBALS['ISC_CLASS_DB']->Quote($OrderId)."'");
			}

			return $messages;
		}

		private function ViewOfferMessages($MsgDesc = "", $MsgStatus = "")
		{
			$new_messages = 0;
			$total_messages = 0;
			$GLOBALS['MessageGrid'] = "";
			...
			if(isset($_REQUEST['orderId'])) {
				...
				if($total_messages == 1) {
					$lang = "OfferMessagesIntro1";
				} else {
					$lang = "OfferMessagesIntroX";
				}
				...
				if (!empty($message_list)) {
					foreach($message_list as $message) {
						...
						$GLOBALS['ISC_CLASS_TEMPLATE']->SetTemplate("offermessage.manage.row");
				...
				$GLOBALS['ViewOfferMessages'] = sprintf(GetLang('ViewOfferMessages'), $order_id);
				$GLOBALS['ISC_CLASS_TEMPLATE']->SetTemplate("offermessages.manage");
				$GLOBALS['ISC_CLASS_TEMPLATE']->ParseTemplate();
			}
		}
		...
		private function UpdateOrderMessageStatus()
		{
			if (isset($_GET['orderId']) && isset($_GET['messageId']) && isset($_GET['status'])) {
				...
				if ($GLOBALS['ISC_CLASS_DB']->UpdateQuery("offer_messages", $updatedMessage, "messageid='".$GLOBALS['ISC_CLASS_DB']->Quote($message_id)."'")) {
					// Log this action
					$GLOBALS['ISC_CLASS_LOG']->LogAdminAction($message_id, $_GET['status']);

					$this->ViewOfferMessages(sprintf(GetLang('OrderMessageStatusChanged'), $status), MSG_SUCCESS);
				} else {
					$this->ViewOfferMessages(sprintf(GetLang('OrderMessageStatusChangeFailed'), $status), MSG_ERROR);
				}
			}
		}

		private function FlagOfferMessage()
		{
			if(isset($_GET['flagState']) && isset($_GET['orderId']) && isset($_GET['messageId'])) {
				...
				if($GLOBALS['ISC_CLASS_DB']->UpdateQuery("offer_messages", $updatedMessage, "messageid='".$GLOBALS['ISC_CLASS_DB']->Quote($message_id)."'")) {
					...
					$this->ViewOfferMessages(GetLang($lang), MSG_SUCCESS);
				}
				else {
					$this->ViewOfferMessages(sprintf(GetLang('OrderFlaggedFailed'), $flag_state), MSG_ERROR);
				}
			}
		}

		private function DeleteOfferMessages()
		{
			if(isset($_POST['orderId']) && is_array($_POST['messages'])) {
				...
				$query = sprintf("delete from [|PREFIX|]offer_messages where messageorderid='%d' and messageid in('%s')", $GLOBALS['ISC_CLASS_DB']->Quote($order_id), $message_ids);

				if($GLOBALS['ISC_CLASS_DB']->Query($query)) {
					// Log this action
					$GLOBALS['ISC_CLASS_LOG']->LogAdminAction($order_id, count($_POST['messages']));

					$this->ViewOfferMessages(GetLang('OrderMessagesDeletedOK'), MSG_SUCCESS);
				}
				else {
					$this->ViewOfferMessages(GetLang('OrderMessagesDeletedFailed'), MSG_ERROR);
				}
			}
		}
		...
		{
			$query = sprintf("select ordcustid, (select concat(custconfirstname, ' ', custconlastname) from [|PREFIX|]customers where customerid=ordcustid) as custname, (select custconemail from [|PREFIX|]customers where customerid=ordcustid) as custemail  from [|PREFIX|]offers where orderid='%d'", $GLOBALS['ISC_CLASS_DB']->Quote($OrderId));
			$result = $GLOBALS['ISC_CLASS_DB']->Query($query);

			if ($row = $GLOBALS['ISC_CLASS_DB']->Fetch($result)) {
				return sprintf("%s <%s>", $row['custname'], $row['custemail']);
			} else {
				return sprintf(GetLang('CustomerForOfferX'), $OrderId);
			}
		}
		...
		*/
		...
		{
			$query = sprintf("select subject from [|PREFIX|]offer_messages where messageorderid='%d' and messagefrom='customer' order by messageid desc limit 1", $GLOBALS['ISC_CLASS_DB']->Quote($OrderId));
			$result = $GLOBALS['ISC_CLASS_DB']->Query($query);

			if ($row = $GLOBALS['ISC_CLASS_DB']->Fetch($result)) {
				return sprintf(GetLang('OrderMessageRe'), $row['subject']);
			} else {
				return sprintf(GetLang('OfferMessageDefaultSubject'), $OrderId);
			}
		}
		...
		private function CreateOfferMessage()
		{
			if(isset($_GET['orderId'])) {
				...
				$query = sprintf("select ordprodname from [|PREFIX|]order_products where offerid='%s'", $GLOBALS['ISC_CLASS_DB']->Quote($order_id));
				$pResult = $GLOBALS['ISC_CLASS_DB']->Query($query);
				$pRow = $GLOBALS['ISC_CLASS_DB']->Fetch($pResult);
				$ordprodname = $pRow['ordprodname'];

				$query = sprintf("select orddate from [|PREFIX|]offers where orderid='%s'", $GLOBALS['ISC_CLASS_DB']->Quote($order_id));
				$pResult = $GLOBALS['ISC_CLASS_DB']->Query($query);
				$pRow = $GLOBALS['ISC_CLASS_DB']->Fetch($pResult);
				$orddate = $pRow['orddate'];


				$GLOBALS['OrderId'] = $order_id;
				$GLOBALS['FormAction'] = "saveNewOfferMessage";
				...
				$GLOBALS['MessageSubject'] = $this->GetRecentCustomerMessage($order_id);
				$GLOBALS['MessageContent']   = " Offer Date :  ".date("d-M-Y",$orddate)."\n\n ";
				$GLOBALS['MessageContent'].= " Offer Product :  ".$ordprodname."\n ";

				$GLOBALS['ISC_CLASS_TEMPLATE']->SetTemplate("offermessage.form");
				$GLOBALS['ISC_CLASS_TEMPLATE']->ParseTemplate();
			}
		}
		...
		private function EditOfferMessage()
		{
			if(isset($_GET['orderId']) && isset($_GET['messageId'])) {
				...
				$message_id = (int)$_GET['messageId'];
				$query = sprintf("select * from [|PREFIX|]offer_messages where messageid='%d' and messageorderid='%d'", $GLOBALS['ISC_CLASS_DB']->Quote($message_id), $GLOBALS['ISC_CLASS_DB']->Quote($order_id));
				$result = $GLOBALS['ISC_CLASS_DB']->Query($query);

				if($row = $GLOBALS['ISC_CLASS_DB']->Fetch($result)) {
					$GLOBALS['OrderId'] = $order_id;
					$GLOBALS['FormAction'] = "saveUpdatedOfferMessage";
		...
		private function SavedUpdatedOrderMessage()
		{
			if(isset($_POST['orderId']) && isset($_POST['messageId']) && isset($_POST['subject']) && isset($_POST['message'])) {
				...
				if($GLOBALS['ISC_CLASS_DB']->UpdateQuery("offer_messages", $updatedMessage, "messageid='".$GLOBALS['ISC_CLASS_DB']->Quote($message_id)."'")) {
					...
					$this->ViewOfferMessages(GetLang('OrderMessageUpdatedOK'), MSG_SUCCESS);
				}
				else {
					$this->ViewOfferMessages(GetLang('OrderMessagesUpdatedFailed'), MSG_ERROR);
				}
			}
		}
		...
		private function SearchOrdersRedirect()
		{
			...
			if(isset($_GET['viewName']) && $_GET['viewName'] != '') {
				...
				if($search_id > 0) {
					...
					$this->ManageOffers(sprintf(GetLang('ViewAlreadExists'), $_GET['viewName']), MSG_ERROR);
				}
			}
			// Plain search
			else {
		...
		*/
		private function CustomSearch()
		{
			...
			if (isset($_REQUEST['new'])) {
				$this->ManageOffers(GetLang('CustomSearchSaved'), MSG_SUCCESS);
			} else {
				$this->ManageOffers();
			}
		}
		...
		private function DeleteCustomSearch()
		{
			...
			if($GLOBALS['ISC_CLASS_ADMIN_CUSTOMSEARCH']->DeleteSearch($_GET['searchId'])) {
				...
				$this->ManageOffers(GetLang('DeleteCustomSearchSuccess'), MSG_SUCCESS);
			}
			else {
				$this->ManageOffers(GetLang('DeleteCustomSearchFailed'), MSG_ERROR);
			}
		}
		...
		*/
		...
		public function GetCartApi($sessionId='', $reset=false)
		{
			...
			if(is_null($classApi)) {
				$classApi = new ISC_ADMIN_OFFER_API;
		...
		private function AddOrder()
		{
			...
			$GLOBALS['FormAction'] = 'saveNewOffer';
		...
		private function SaveNewOrder()
		{
			...
			if(!$orderId) {
				...
				if(isset($_REQUEST['addAnother'])) {
					...
					$location = 'index.php?ToDo=viewOffers';
				}
		 ...
		 */
		private function SaveUpdatedOffer()
		{
			if(!$GLOBALS['ISC_CLASS_ADMIN_AUTH']->HasPermission(AUTH_Edit_Orders)) {
				$GLOBALS['ISC_CLASS_ADMIN_ENGINE']->DoHomePage(GetLang('Unauthorized'), MSG_ERROR);
				return;
			...
			if(!isset($order['orderid'])) {
				FlashMessage(GetLang('InvalidOrder'), MSG_ERROR, 'index.php?ToDo=viewOffers');
			}
			...
			if(!$this->CommitOrder($_POST, $order['orderid'])) {
				...
				if(isset($_REQUEST['addAnother'])) {
					$location = 'index.php?ToDo=editOffer&orderId='.$order['orderid'];
				}
				else {
					$location = 'index.php?ToDo=viewOffers';
				}
		...
		private function CommitOrder($data, $orderId=0)
		{
			...
			if($data['ordcustid'] == 0 && $data['customerType'] == 'new') {
				$customerData = array(
					...
					'storecredit' => DefaultPriceFormat($data['custstorecredit'])
				);
		...
		private function RefundOrder()
		{
			...
			if($message != '') {
				FlashMessage($message, $messageStatus, 'index.php?ToDo=viewOffers');
			}
