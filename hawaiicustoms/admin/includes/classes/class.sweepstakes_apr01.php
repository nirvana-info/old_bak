       ...
       public function manageSweepstakes($MsgDesc = "", $MsgStatus = "")
        ...
        public function ManageSweepstakesGrid(&$numMake)
        {
            ...
            if($numMake > ISC_SWEEPSTAKES_PER_PAGE) {
                ...
                $GLOBALS['Nav'] .= BuildPagination($numMake, ISC_SWEEPSTAKES_PER_PAGE, $page, sprintf("index.php?ToDo=viewSweepstakes%s", $sortURL));
            }
            else {
                $GLOBALS['Nav'] = "";
            }
            ...
            BuildAdminSortingLinks($sortLinks, "index.php?ToDo=viewSweepstakes&amp;".$searchURL."&amp;page=".$page, $sortField, $sortOrder);
...
//            echo $numMake;exit;
        ...
        public function _GetSweepstakesList($Start, $SortField, $SortOrder, &$NumResults)
        {
            ...
            $query = "SELECT sweepstakesid, name, title, startdate, enddate FROM [|PREFIX|]sweepstakes_master s";
        ...
        */
        ...
        public function SaveUsersSweepstakes() {
            if(isset($_POST['email'])) {
                ...
                $newsletter = isset($_POST['receivingmail']) ? trim($_POST['receivingmail']) : 0;
                ...
                if($cnt >= 5) {
                    $this->manageUsersSweepstakes(GetLang('Sweepstakes5Exists'), MSG_ERROR);
                }
                else {
...
//            echo $numMake;exit;
        ...
        {
             $sweepstakesid = 1; # This id should be passed as dynamic by selecting that sweepstakes. Now its hard coded -- Baskaran
            ...
            $query = "SELECT sweepsuserid, email, firstname, lastname, phonenumber, city, status, createddate FROM [|PREFIX|]sweepstakes_users s ORDER BY createddate desc";
        ...
        public function ViewUsersSweepstakes($MsgDesc = "", $MsgStatus = "")
        {
            if(isset($_GET['sid'])) {
                ...
                if($row = $GLOBALS["ISC_CLASS_DB"]->Fetch($result)) {
                    ...
                    $GLOBALS['CreatedDate'] = $row['createddate'];
