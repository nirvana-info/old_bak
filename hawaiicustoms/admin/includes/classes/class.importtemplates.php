	...
	public function HandleToDo($do)
	{
		...
		switch ($do) {
			case 'createimporttemplate':
				$GLOBALS['BreadcrumEntries'] = array(GetLang('Home') => "index.php", GetLang('ImportTemplates') => "index.php?ToDo=viewimporttemplates", GetLang('AddImportTemplate') => "index.php?ToDo=createExportTemplate");
			...
			case 'editimporttemplate':
				$GLOBALS['BreadcrumEntries'] = array(GetLang('Home') => "index.php", GetLang('ImportTemplates') => "index.php?ToDo=viewimporttemplates", GetLang('EditImportTemplate') => "index.php?ToDo=EditImportTemplate");
