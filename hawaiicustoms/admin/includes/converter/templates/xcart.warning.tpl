	...
	<tr>
		<td class="Heading1">%%LNG_XCartImportTitle%%</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td>
		  <table class="Panel">
			<tr>
			  <td class="Heading2">%%LNG_XCartWarningTitle%%</td>
			</tr>
			<tr>
				<td class="FieldLabel"><label><input type="checkbox" style="vertical-align: middle" />&nbsp;&nbsp;%%LNG_XCartWarning1%%</label></td>
			</tr>
