	...
	<tr>
		<td class="Heading1">%%LNG_CubeCartImportTitle%%</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td>
		  <table class="Panel">
			<tr>
			  <td class="Heading2">%%LNG_CubeCartWarningTitle%%</td>
			</tr>
			<tr>
				<td class="FieldLabel"><label><input type="checkbox" style="vertical-align: middle" />&nbsp;&nbsp;%%LNG_CubeCartWarning1%%</label></td>
			</tr>
			<tr>
				<td class="FieldLabel PanelBottom"><label><input type="checkbox" style="vertical-align: middle" />&nbsp;&nbsp;%%LNG_CubeCartWarning2%%</label></td>
			</tr>
