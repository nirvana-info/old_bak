	...
	<tr>
		<td class="Heading1">%%LNG_OsCommerceExportTitle%%</td>
	</tr>
	<tr>
		<td>
			...
			<tr>
				<td class="Intro">
					<div>
					%%LNG_OsCommerceExportWarningIntro%%
					</div>
				</td>
			</tr>
			<tr>
	...
	<tr>
		<td>
		  <table class="Panel">
			<tr>
			  <td class="Heading2">%%LNG_OsCommerceExportWarningTitle%%</td>
			</tr>
			<tr>
				<td class="FieldLabel"><label><input type="checkbox" style="vertical-align: middle" />&nbsp;&nbsp;%%LNG_OsCommerceExportWarning1%%</label></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label><input type="checkbox" style="vertical-align: middle" />&nbsp;&nbsp;%%LNG_OsCommerceExportWarning2%%</label></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label><input type="checkbox" style="vertical-align: middle" />&nbsp;&nbsp;%%LNG_OsCommerceExportWarning3%%</label></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label><input type="checkbox" style="vertical-align: middle" />&nbsp;&nbsp;%%LNG_OsCommerceExportWarning4%%</label></td>
			</tr>
