...
<tr>
	<td class="Heading1">%%LNG_ZenCartImportTitle%%</td>
</tr>
<tr>
	<td>
...
<tr>
	<td>
	  <table class="Panel">
		<tr>
		  <td class="Heading2">%%LNG_ZenCartWarningTitle%%</td>
		</tr>
		<tr>
			<td class="FieldLabel"><label><input type="checkbox" style="vertical-align: middle" />&nbsp;&nbsp;%%LNG_ZenCartWarning1%%</label></td>
		</tr>
		<tr>
			<td class="FieldLabel PanelBottom"><label><input type="checkbox" style="vertical-align: middle" />&nbsp;&nbsp;%%LNG_ZenCartWarning2%%</label></td>
		</tr>
