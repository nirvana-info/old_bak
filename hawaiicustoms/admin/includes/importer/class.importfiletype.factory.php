<?php
define("TYPE_ROOT", APP_ROOT . "/includes/importer/filetypes/");

require_once APP_ROOT . "/includes/importer/class.importfiletype.php";
...
*/
class ISC_ADMIN_IMPORTFILETYPE_FACTORY
{
	/**
	...
	*/
	public static function GetImportFileType($type)
	{	//, $templateid, $where
		...
		if (is_file($file)) {
			...
			$className = "ISC_ADMIN_IMPORTFILETYPE_" . $type;
	...
	*/
	public static function GetImportFileTypeList()
	{
		...
		foreach($files as $file) {
			...
			*/
			 $className = "ISC_ADMIN_IMPORTFILETYPE_" . strtoupper($file); //$typeName;
