	...
	<script type="text/javascript">
		...
		function LoadProductsByNumViewsGrid() {
			...
			jQuery.ajax({url: 'index.php?ToDo=prodStatsByNumViewsGrid&vendorId=%%GLOBAL_VendorId%%&Page='+productsByNumViewsCurrentPage+'&Show='+productsPerPage+'&SortBy='+productsByNumViewsSortField+'&SortOrder='+productsByNumViewsSortOrder+'&showby='+showby,
					 success: function(data) {
 ...
 window.location = 'index.php?ToDo=prodStatsByNumViewsGrid&vendorId=%%GLOBAL_VendorId%%&Page='+productsByNumViewsCurrentPage+'&Show='+productsPerPage+'&SortBy='+productsByNumViewsSortField+'&SortOrder='+productsByNumViewsSortOrder+'&showby='+showby+'&export=yes';            
