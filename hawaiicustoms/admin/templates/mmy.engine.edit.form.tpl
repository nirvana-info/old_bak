		...
		<td>
			<table class="Panel">
                ...
                <tr>
                    ...
                    <td>
                        <input type="hidden" name="eid" id="eid" value="%%GLOBAL_Eid%%">
                        <input type="text" name="enginetype" id="enginetype" class="Field200" value="%%GLOBAL_EngineType%%">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="liter" id="liter" class="Field200" value="%%GLOBAL_Liter%%">
