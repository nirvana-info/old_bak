...
%%GLOBAL_CalendarDateTypeOptions%%
			...
			<div id="div1" style="padding-top:10px; padding-left:10px" class="text">
                ...
                <select id="showby" name="showby" onchange="submitForm();">    
                 ...
                 &nbsp;  <input type="button" value="Export Results"  onclick = "exportsearchresults();" />   
	...
	<script type="text/javascript">
        ...
        function submitForm()   {                               
            ...
            document.getElementById('Show').value = document.getElementById('Show1').value;*/
		...
		function LoadProductsByNumViewsGrid() {
			...
			jQuery.ajax({url: 'index.php?ToDo=prodStatsByNumViewsGrid&vendorId=%%GLOBAL_VendorId%%&From=%%GLOBAL_FromStamp%%&To=%%GLOBAL_ToStamp%%&Page='+productsByNumViewsCurrentPage+'&Show='+productsPerPage+'&SortBy='+productsByNumViewsSortField+'&SortOrder='+productsByNumViewsSortOrder+'&showby='+showby+'&calendar='+calendar,
					 success: function(data) {
         ...
         function exportsearchresults() {
            ...
            var showby = document.getElementById('showby').value;
            var calendar = document.getElementById('Calendar').value;                        
	    window.location = 'index.php?ToDo=prodStatsByNumViewsGrid&vendorId=%%GLOBAL_VendorId%%&From=%%GLOBAL_FromStamp%%&To=%%GLOBAL_ToStamp%%&Page='+productsByNumViewsCurrentPage+'&Show='+productsPerPage+'&SortBy='+productsByNumViewsSortField+'&SortOrder='+productsByNumViewsSortOrder+'&showby='+showby+'&calendar='+calendar+'&export=yes';            
