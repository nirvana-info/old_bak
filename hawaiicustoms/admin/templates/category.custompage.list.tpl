<head>
	...
	function PreviewCustomItem(ItemId)
	{
		...
		var win = window.open('index.php?ToDo=prevCateCustomContent&itemId='+ItemId, 'PreviewCustomItem', 'width=500,height=600,left='+l+',top='+t+',scrollbars=1');
	}
    ...
    function ConfirmDeleteSelected()
	{
		...
		if(checkedCnt > 0)
		{
			if(confirm("Are you sure?"))
			{
				$("#frmContents").attr('action', 'index.php?ToDo=deleteCateCustomContents&contentId=%%GLOBAL_ContentId%%');
				$("#frmContents").submit();
			}
		}
		else
