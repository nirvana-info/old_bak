	  ...
	  <tr>
				...
				<td>
				  <table class="Panel">
                    ...
                    <tr>
						...
						<td>
							<input type="text" name="displayName" id="displayName" class="Field400" value="">
			...
			<td>
			    <input type="file" id="serieslogoimagefile" name="serieslogoimagefile" class="Field" />
                            <img onmouseout="HideHelp('d17');" onmouseover="ShowHelp('d17', '%%LNG_SeriesLogoImage%%', '%%LNG_SeriesImageHelp%%')" src="images/help.gif" width="24" height="16" border="0">
                    ...
                    <td>
                        <table class="Panel">
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea rows="8" cols="75" name="controlscript" id="controlscript"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td class="FieldLabel">
                                ...
                                <td>
                                    <textarea  rows="8" cols="75" name="trackingscript" id="trackingscript"></textarea>
                                </td>
                            </tr>
                        </table>
                    </td>
...
<script type="text/javascript">
	...
	$(function(){
		var dispName = {'brandname':'', 'seriesname':'', 'catename':''};
		$('#vendor').change(function(){
			if($(this).val()!=0){
				dispName.brandname = $(this).children(':selected').text();
				getCateName($(this).val());
			}else{
			    dispName.brandname = '';
			    dispName.catename = '';
			}
		...
		function getCateName(cateId){
			$.ajax({
				type: "POST",
				url: "index.php?ToDo=GetBrandseriesCateName",
				data: {
				         'categoryId': cateId
				      },
				success: function(data){
					if(data != 'notFound'){
						dispName.catename = data;
						setDisplayName();
					}
				}
			});
