<table id="OuterPanel" cellSpacing="0" cellPadding="0" width="100%">
	<tr>
		<td class="Heading1">
			%%LNG_OrderReviewRequestStatusInProgress%%
		</td>
	</tr>
	<tr>
		<td class="Intro">
...
<script type="text/javascript">
	...
	function requestOrderUpdate()
	{
		$.ajax({
			type	: "GET",
			url	    : "index.php",
			data	: "ToDo=sendRewRequests&o=" + orderidx[currentOrder] + "&success=" + success + "&failed=" + failed +"&templateId="+templateId,
	...
	function handleOrderUpdate(data)
	{
		...
		$("#ProgressBarStatus").text("%%LNG_OrderReviewRequestStatusUpdating%% " + orderidx.length + " %%LNG_Orders%%");
