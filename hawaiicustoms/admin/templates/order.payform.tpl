    ...
    <tr>
        <td>
            <div>
                ...
                <input type="hidden" name="orderamount" id="orderamount" value="%%GLOBAL_amount%%">
            </div>
        </td>
    </tr>
    <tr>
        <td>
            <table class="Panel">
                ...
                <tr>
                        ...
                        <td>
                            <input type="text" name="name" id="name" class="Field200" value="%%GLOBAL_cardholdername%%">
                        </td>
                </tr>
                <tr>
                    <td class="FieldLabel">
                    ...
                    <td>
                        <input type="text" name="ccno" id="ccno" class="Field200" value="">
                    </td>
                </tr>
                 <tr>
                        <td class="FieldLabel">
