...
<!--							<select name="vendor" id="vendor" class="Field400" style="%%GLOBAL_HideVendorSelect%%" onchange="toggleVendorSettings($(this).val());">-->
		    ...
		    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                        <input type="radio" name="comp_type" id="comp_type" value="0" %%GLOBAL_single%% >Single
                        <input type="radio" name="comp_type" id="comp_type" value="1" %%GLOBAL_multiple%% > Multiple           

                            <img onmouseout="HideHelp('d43');" onmouseover="ShowHelp('d43', '%%LNG_Compseltype%%', '%%GLOBAL_CompseltypeHelp%%')" src="images/help.gif" width="24" height="16" border="0">
...
<div id="div8" style="padding-top: 10px;">
                  <table class="Panel" id="tabVariation">
                    ...
                    <tr>
                        ...
                        <td >
                            <select name="editproduct" id="editproduct" class="Field200" onchange="displaytab(this.value)">
                                %%GLOBAL_ProductVariationList%%
                            </select> &nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="%%LNG_Remove%%" onclick="remove_variations();"/>
            ...
            <input type="hidden" id="hdnname" name="hdnname" class="Field50" value=""> 
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea cols="50" rows="5" id="complementaryitems" name="complementaryitems" readonly="true" onblur = "updatecomphidden()"></textarea>
                            %%GLOBAL_Complementaryhidden%%     
...
//2011-2-22 Ronnie add, fix select onchange not called on firefox,chrome
function nokeyup(e){ 
...
var srcb=e.srcElement;
if(srcb==null) srcb=e.target;
if(srcb.tagName=="SELECT" && (e.keyCode>=37 || e.keyCode<=40 ) && srcb.disabled==false)
//alert(e.srcElement.value);
srcb.onchange();
} 
document.onkeyup = nokeyup; // for all others 
function updatecomphidden()
{
	//clear all the hiden content. by mike
var product = document.getElementById('editproduct');
for(var i =0;i <product.options.length; i ++)
{
	if(product.options[i].value >0)
	{
		var ref = document.getElementById('comphidden['+product.options[i].value+']');
		if(ref != null)
		{
			ref.value = "";
		}
...
document.getElementById('comphidden['+id+']').value = document.getElementById('complementaryitems').value
