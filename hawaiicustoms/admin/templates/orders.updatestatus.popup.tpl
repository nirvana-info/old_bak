<table id="OuterPanel" cellSpacing="0" cellPadding="0">
	<tr>
		<td class="Heading1">
...
<script type="text/javascript">
	...
	{
		if(errororderid.length>0){
			//alert("order id %s cannot be updated!".replace("%s",errororderid));
		}
		window.parent.document.getElementById('GridContainer').innerHTML = data;
		window.parent.BindAjaxGridSorting();
		window.parent.setFailureUpdateStatusOrder(errororderid);
