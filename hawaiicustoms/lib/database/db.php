...
*
* @version     $Id: db.php 138 2009-02-26 05:47:56Z chris.boulton $
...
class Db
{
	...
	*/
	 ...
	 */
	function InsertQuery($table, $values, $useNullValues=false, $isMultiInsert=false)
	{
		...
		if($isMultiInsert){
			...
			$query = sprintf('INSERT INTO %1$s[|PREFIX|]%2$s%1$s (%1$s%3$s%1$s) VALUES (%4$s)', $this->EscapeChar, $table, $fields, $valStr);
