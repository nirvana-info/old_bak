...
<!--							<select name="vendor" id="vendor" class="Field400" style="%%GLOBAL_HideVendorSelect%%" onchange="toggleVendorSettings($(this).val());">-->
                            <select name="vendor" id="vendor" class="Field400" style="%%GLOBAL_HideVendorSelect%%" onchange="showBrand(this.value);toggleVendorSettings($(this).val());"> 
								%%GLOBAL_VendorList%%
							</select>
			...
			<div id="div6" style="padding-top: 10px;">
				...
				<table width="100%" class="Panel">
					...
					<tr>
						...
						<td>
							<select name="brandbox" id="brandbox" class="Field200" onchange="SelectSeries(this.value);">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            %%LNG_OrCreateANewSeries%%:
                            <input type="text" id="seriesname" name="seriesname" class="Field100" style="width:120px">
                            <img onmouseout="HideHelp('d40');" onmouseover="ShowHelp('d40', '%%LNG_Productseries%%', '%%GLOBAL_ProductseriesHelp%%')" src="images/help.gif" width="24" height="16" border="0">
                            <div style="display:none" id="d40"></div>
                        </td>
                    </tr>                    
