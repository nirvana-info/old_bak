...
$newstartDate = mktime(0, 0, 0, date("m",$graphFrom), date("d",$graphFrom), date("Y",$graphFrom));
$newendDate = mktime(0, 0, 0, date("m",$graphFrom), date("d",$graphFrom)+ 1, date("Y",$graphFrom));
$dateformat =  date("Y-m-d",$newstartDate); 
...
$newstartDate = mktime(0, 0, 0, date("m",$graphFrom), date("d",$graphFrom)+ $i, date("Y",$graphFrom));
$newendDate = mktime(0, 0, 0, date("m",$graphFrom), date("d",$graphFrom)+ ($i+1), date("Y",$graphFrom));
$dateformat =  date("Y-m-d",$newstartDate); 
