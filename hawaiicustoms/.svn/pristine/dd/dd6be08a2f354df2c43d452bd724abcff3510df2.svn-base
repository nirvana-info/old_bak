<?php
	...
	$GLOBALS['RewriteRules'] = array(
        ...
        "search" => array(
            "class" => "class.newsearch.php",
            "name" => "ISC_NEWSEARCH",
            "global" => "ISC_CLASS_NEWSEARCH"
        ) ,
        "account" => array(
        ...
        "companygiftcertificates" => array(
            "class" => "class.companygiftcertificates.php",
            "name" => "ISC_COMPANYGIFTCERTIFICATES",
            "global" => "ISC_CLASS_COMPANYGIFTCERTIFICATES"
        ) ,
        "cart" => array(
	...
	"order" => array(
		...
		"a-b-testing" => array(
			"class" => "class.abtesting.php",
			"name" => "ISC_ABTESTING",
			"global" => "ISC_CLASS_ABTESTING"
		)
	);
