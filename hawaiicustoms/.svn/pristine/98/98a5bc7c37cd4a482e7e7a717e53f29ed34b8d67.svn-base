		...
		<td>
			<table class="Panel">
                ...
                <tr>
                        ...
                        <td>
                            <input type="text" name="name" id="name" class="Field200" value="">
				...
				<tr>
					<td class="FieldLabel">
						<span class="Required">*</span>&nbsp;%%LNG_Title%%:
					</td>
					<td>
						<input type="text" name="title" id="title" class="Field200" value="">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="comments" id="comments" class="Field200" value="">
                ...
                <tr>
                    ...
                    <td>
                        <input type="file" name="videos" id="videos" class="Field200" value="">
                        <img onmouseout="HideHelp('d6');" onmouseover="ShowHelp('d6', '%%LNG_Videos%%', '%%GLOBAL_1%%')" src="images/help.gif" width="24" height="16" border="0">
