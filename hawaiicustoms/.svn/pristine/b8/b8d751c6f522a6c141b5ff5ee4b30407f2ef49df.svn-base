	...
	<tr>
		<td class="Heading1">%%LNG_XCartExportTitle%%</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td>
		  <table class="Panel">
			<tr>
			  <td class="Heading2">%%LNG_XCartExportWarningTitle%%</td>
			</tr>
			<tr>
				<td class="FieldLabel"><label><input type="checkbox" style="vertical-align: middle" />&nbsp;&nbsp;%%LNG_XCartExportWarning1%%</label></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label><input type="checkbox" style="vertical-align: middle" />&nbsp;&nbsp;%%LNG_XCartExportWarning2%%</label></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label><input type="checkbox" style="vertical-align: middle" />&nbsp;&nbsp;%%LNG_XCartExportWarning3%%</label></td>
			</tr>
			<tr>
				<td class="FieldLabel"><label><input type="checkbox" style="vertical-align: middle" />&nbsp;&nbsp;%%LNG_XCartExportWarning4%%</label></td>
			</tr>
