	...
	<tr>
		<td>
			<div id="div0" style="padding-top: 10px;">
				...
				<tr>
					<td class="FieldLabel">
						&nbsp;&nbsp; <label for="AllowPurchasing">%%LNG_AllowPurchasing%%?</label>
					</td>
					<td>
				...
				<tr>
					<td class="FieldLabel">
						&nbsp;&nbsp; <label for="LimitCustomerLoginTimes">%%LNG_LimitCustomerLoginTimes%%</label>
					</td>
					<td>
						<input type="text" name="LimitCustomerLoginTimes" id="LimitCustomerLoginTimes" value="%%GLOBAL_LimitCustomerLoginTimes%%" class="Field20" style="text-align:center;" /> times
						<img onmouseout="HideHelp('help_LimitCustomerLoginTimes');" onmouseover="ShowHelp('help_LimitCustomerLoginTimes', '%%LNG_LimitCustomerLoginTimes%%', '%%LNG_LimitCustomerLoginTimesHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
						<div style="display:none" id="help_LimitCustomerLoginTimes"></div>
					</td>
				</tr>
				<!--<=zcs-->
				<!--zcs=>-->
				<tr>
					<td class="FieldLabel">
						&nbsp;&nbsp; <label for="UserQA">%%LNG_UserQA%%</label>
					</td>
					<td>
						<input type="text" name="UserQA" id="UserQA" value="%%GLOBAL_UserQA%%" class="Field250" />
						<img onmouseout="HideHelp('help_UserQA');" onmouseover="ShowHelp('help_UserQA', '%%LNG_UserQA%%', '%%LNG_UserQAHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
						<div style="display:none" id="help_UserQA"></div>
					</td>
				</tr>
				<!--<=zcs-->
				<!--zcs=>-->
				<tr>
					<td class="FieldLabel">
						&nbsp;&nbsp; <label for="AddonProductShownNum">%%LNG_AddonProductShownNum%%</label>
					</td>
					<td>
						<input type="text" name="AddonProductShownNum" id="AddonProductShownNum" value="%%GLOBAL_AddonProductShownNum%%" class="Field20" style="text-align:center;" />
						<img onmouseout="HideHelp('help_AddonProductShownNum');" onmouseover="ShowHelp('help_AddonProductShownNum', '%%LNG_AddonProductShownNum%%', '%%LNG_AddonProductShownNumHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
						<div style="display:none" id="help_AddonProductShownNum"></div>
					</td>
				</tr>
				<!--<=zcs-->
				<tr>
			...
			<div id="div2" style="padding-top: 10px;">
				<table width="100%" class="Panel">
                    ...
                    <tr>
                        <td class="FieldLabel">
                            <span class="Required">*</span> <label for="HomeFeaturedCategories">%%LNG_HomeFeaturedCategories%%:</label>
                        </td>
                        <td>
                            <input type="text" name="HomeFeaturedCategories" id="HomeFeaturedCategories" value="%%GLOBAL_HomeFeaturedCategories%%" class="Field40" />
                            <img onmouseout="HideHelp('d53');" onmouseover="ShowHelp('d53', '%%LNG_HomeFeaturedCategories%%', '%%LNG_HomeFeaturedCategoriesHelp%%')" src="images/help.gif" width="24" height="16" border="0" />
                            <div style="display:none" id="d53"></div>
                        </td>
                    </tr>
                    <tr>
						<td class="FieldLabel">
				...
				<table width="100%" class="Panel">
                    ...
                    <tr>
                        <td class="FieldLabel">
                            &nbsp;&nbsp; <label for="ShowBestOffer">%%LNG_ShowBestOffer%%?</label>
                        </td>
                        <td class="PanelBottom">
                            <input type="checkbox" name="ShowBestOffer" id="ShowBestOffer" value="ON" %%GLOBAL_IsBestOfferShown%% /> <label for="ShowBestOffer">%%LNG_YesShowBestOffer%%</label>
                        </td>
                    </tr>
                    <tr>
                        <td class="FieldLabel">
                            &nbsp;&nbsp; <label for="ShowOnSale">%%LNG_ShowOnSale%%?</label>
                        </td>
                        <td class="PanelBottom">
                            <input type="checkbox" name="ShowOnSale" id="ShowOnSale" value="ON" %%GLOBAL_IsOnSaleShown%% /> <label for="ShowOnSale">%%LNG_YesShowOnSale%%</label>
                        </td>
                    </tr>
                   <tr>
<td class="FieldLabel">
    &nbsp;&nbsp; <label for="DisplayPriceRange">%%LNG_DisplayPriceRange%%?</label>
</td>
<td class="PanelBottom">
    <input type="checkbox" name="DisplayPriceRange" id="DisplayPriceRange" value="ON" %%GLOBAL_IsDisplayPriceRange%% /> <label for="DisplayPriceRange">%%LNG_YesDisplayPriceRange%%</label>
</td>
</tr>    
                ...
                <table width="100%" class="Panel">
                    <tr>
                        <td class="Heading2" colspan="2">%%LNG_SearchDisplay%%</td>
                    </tr>
                    <tr>   
                        <td class="FieldLabel">
                            %%LNG_SearchResult%%:
