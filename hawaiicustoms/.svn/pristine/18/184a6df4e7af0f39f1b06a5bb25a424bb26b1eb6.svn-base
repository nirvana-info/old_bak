	...
	<table id="Table13" cellSpacing="0" cellPadding="0" width="100%">
			...
			<table id="IntroTable" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					<td class="Intro" valign="top">
						<input type="button" name="IndexAddButton" value="%%LNG_CreateMessage%%..." id="IndexCreateButton" class="SmallButton" onclick="document.location.href='index.php?ToDo=createOfferMessage&amp;orderId=%%GLOBAL_OrderId%%'" />
						...
						&nbsp;<input type="button" name="IndexReturnButton" value="%%LNG_ViewOffers%%" class="SmallButton" onclick="document.location.href='index.php?ToDo=viewOffers'" />
					</td>
				</tr>
			</table>
			<br />
		...
		<td style="display: %%GLOBAL_DisplayGrid%%">
			<form name="frmMessages" id="frmMessages" method="post" action="index.php?ToDo=deleteOfferMessages">
