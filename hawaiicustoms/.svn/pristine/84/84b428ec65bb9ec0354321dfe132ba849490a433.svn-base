...
<table width="100%" style="background-color:#fff" class="Panel">
	...
	<tr>
		...
		<td>
			...
			<input name="delivery_length" id="delivery_length" class="Field50">%%GLOBAL_LengthUnit%%
	...
	<tr>
		...
		<td>
			...
			<input name="delivery_width" id="delivery_width" class="Field50">%%GLOBAL_LengthUnit%%
	...
	<tr>
		...
		<td>
			...
			<input name="delivery_height" id="delivery_height" class="Field50">%%GLOBAL_LengthUnit%%
