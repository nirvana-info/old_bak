...
/*
	The below code is commented as client dont want ot be checked in translation table.
	Commented on 16-4-10 - vikas
	16-4-10 - Starts
*/
/*
...
array_push($selected, "prodmake" , "prodmodel","prodsubmodel","prodstartyear","prodendyear");
		...
		//add a section of code to manage this type of year range problem. As per the  given example,  delete the first row and insert the second row completely to the data base.
