	...
	<tr id="tr%%GLOBAL_CustomerId%%" class="GridRow" onmouseover="this.className='GridRowOver'" onmouseout="this.className='GridRow'">
		...
		<td>
			%%GLOBAL_LoginCustomerLink%%
			<a href="#" class="%%GLOBAL_HasNotesClass%% ViewNotesLink" onclick="Customers.ViewNotes('%%GLOBAL_CustomerId%%'); return false;">%%LNG_CustomerNotesLink%%</a>
