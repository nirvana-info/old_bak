		    ...
		    var catid = "Universal_"+document.getElementById("categoryId").value;
                    if(confirm('%%GLOBAL_CancelMessage%%'))
                    {
                        if(deptid != '') {
                            document.location.href='index.php?ToDo=viewCategories&deptid='+deptid+'#'+catid;
                        }
                        else {
			  ...
			  <tr>
				<td>
					<ul id="tabnav">
						...
						<li><a href="#" id="tab1" style="%%GLOBAL_DisplayCustom%%">%%LNG_CustomContent%%</a></li>
					</ul>
				</td>
			</tr>
				<tr>
