	...
	public function add_export_template_tables()
	{
		...
		if (!$GLOBALS['ISC_CLASS_DB']->CountResult($res)) {
			...
			$fields = array(
						...
						array('orderStatus', 'orders', 'Order Status', 1, 3),
						array('orderDate', 'orders', 'Order Date', 1, 2),
						array('orderSubtotal', 'orders', 'Subtotal', 1, 4),
						array('orderTaxtotal', 'orders', 'Tax Total', 1, 5),
						array('orderTaxRate', 'orders', 'Tax Rate', 1, 6),
						array('orderTaxName', 'orders', 'Tax Name', 1, 7),
						array('orderTotalIncTax', 'orders', 'Total Includes Tax', 1, 8),
						array('orderShipCost', 'orders', 'Shipping Cost', 1, 9),
						array('orderHandlingCost', 'orders', 'Handling Cost', 1, 11),
						array('orderTotalAmount', 'orders', 'Order Total', 1, 12),
						array('orderCustomerID', 'orders', 'Customer ID', 1, 1),
						array('orderShipMethod', 'orders', 'Ship Method', 1, 10),
						array('orderPayMethod', 'orders', 'Payment Method', 1, 13),
						array('orderTotalQty', 'orders', 'Total Quantity', 1, 14),
						array('orderTotalShipped', 'orders', 'Total Shipped', 1, 15),
						array('orderDateShipped', 'orders', 'Date Shipped', 1, 16),
						array('orderTrackingNo', 'orders', 'Tracking No', 1, 17),
						array('orderCurrency', 'orders', 'Order Currency Code', 1, 18),
						array('orderExchangeRate', 'orders', 'Exchange Rate', 1, 19),
						array('orderNotes', 'orders', 'Order Notes', 1, 20),
						array('orderCustMessage', 'orders', 'Customer Message', 1, 21),
						array('billName', 'orders', 'Billing Name', 0, 22),
						array('billFirstName', 'orders', 'Billing First Name', 1, 23),
						array('billLastName', 'orders', 'Billing Last Name', 1, 24),
						array('billCompany', 'orders', 'Billing Company', 1, 25),
						array('billStreet1', 'orders', 'Billing Street 1', 1, 26),
						array('billStreet2', 'orders', 'Billing Street 2', 1, 27),
						array('billSuburb', 'orders', 'Billing Suburb', 1, 28),
						array('billState', 'orders', 'Billing State', 0, 29),
						array('billStateAbbrv', 'orders', 'Billing State', 1, 30),
						array('billZip', 'orders', 'Billing Zip', 1, 31),
						array('billCountry', 'orders', 'Billing Country', 1, 32),
						array('billSSC', 'orders', 'Billing Suburb + State + Zip', 0, 33),
						array('billPhone', 'orders', 'Billing Phone', 1, 34),
						array('billEmail', 'orders', 'Billing Email', 1, 35),
						array('billFormFields', 'orders', 'Billing Form Fields', 1, 36),
						array('shipName', 'orders', 'Shipping Name', 0, 37),
						array('shipFirstName', 'orders', 'Shipping First Name', 1, 38),
						array('shipLastName', 'orders', 'Shipping Last Name', 1, 39),
						array('shipCompany', 'orders', 'Shipping Company', 1, 40),
						array('shipStreet1', 'orders', 'Shipping Street 1', 1, 41),
						array('shipStreet2', 'orders', 'Shipping Street 2', 1, 42),
						array('shipSuburb', 'orders', 'Shipping Suburb', 1, 43),
						array('shipState', 'orders', 'Shipping State', 0, 44),
						array('shipStateAbbrv', 'orders', 'Shipping State', 1, 45),
						array('shipZip', 'orders', 'Shipping Zip', 1, 46),
						array('shipCountry', 'orders', 'Shipping Country', 1, 47),
						array('shipSSC', 'orders', 'Shipping Suburb + State + Zip', 0, 48),
						array('shipPhone', 'orders', 'Shipping Phone', 1, 49),
						array('shipEmail', 'orders', 'Shipping Email', 1, 50),
						array('shipFormFields', 'orders', 'Shipping Form Fields', 1, 51),
						array('orderProdDetails', 'orders', 'Product Details', 1, 52),
						array('orderProdID', 'orders', 'Product ID', 1, 53),
						array('orderProdQty', 'orders', 'Product Qty', 1, 54),
						array('orderProdSKU', 'orders', 'Product SKU', 1, 55),
						array('orderProdName', 'orders', 'Product Name', 1, 56),
						array('orderProdPrice', 'orders', 'Product Unit Price', 1, 57),
						array('orderProdIndex', 'orders', 'Product Index', 0, 58),
						array('orderProdTotalPrice', 'orders', 'Product Total Price', 1, 59),
						array('orderGLAccount', 'orders', 'Peachtree General Ledger Account', 0, 60),
						array('orderPTTaxType', 'orders', 'Peachtree Tax Type', 0, 61),
						array('orderProductCount', 'orders', '# Unique Products in Order', 0, 62),
						array('orderTodaysDate', 'orders', 'Todays Date', 0, 63),
						array('orderAccountsReceivable', 'orders', 'Peachtree Accounts Receivable Account', 0, 64),
