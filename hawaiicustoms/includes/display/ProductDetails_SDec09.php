		...
		public function SetPanelSettings()
		{
			...
			if($GLOBALS['ISC_CLASS_PRODUCT']->IsPurchasingAllowed()) {
                ...
                if((float)$SalePrice > 0 && $SalePrice < $FinalPrice)    {
                    ...
                    $DiscountPrice = CalculateDiscountPrice($FinalPrice, $DiscountPrice, $productCats[0], $brandseries);
                }
...
$GLOBALS['SNIPPETS']['ProductAddToCart'] = $GLOBALS['ISC_CLASS_TEMPLATE']->GetSnippet("ProductAddToCart");
            ...
            //blessen
            if ($GLOBALS['ISC_CLASS_PRODUCT']->GetFinalPrice() < $GLOBALS['ISC_CLASS_PRODUCT']->GetRetailPrice())        //$GLOBALS['ISC_CLASS_PRODUCT']->GetFinalPrice() replaced by GetPrice
			{
