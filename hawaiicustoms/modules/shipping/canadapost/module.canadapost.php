	...
	*/
	class SHIPPING_CANADAPOST extends ISC_SHIPPING
	{
		...
		*/
		...
		/*
			The origin country zip for Canada Post shipments
		*/
		private $_originzip = "";
		...
		*/
		...
		private function GetQuote()
		{
			...
			", $this->_merchantid, $this->_originzip, $items, $this->_deststate, isc_strtoupper($this->_destcountry), $this->_destzip);
		...
		{
			return "https://obc.canadapost.ca/emo/basicPin.do?MfcIsApiCommand=TraceE&trackingCode=PIN&action=query&language=en&trackingId=" . urlencode($trackingNumber);
		}
	}
