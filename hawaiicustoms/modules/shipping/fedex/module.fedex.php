	...
	*/
	class SHIPPING_FEDEX extends ISC_SHIPPING
	{
		...
		*/
		...
		/*
			The types of rate supported by this provider
		*/
		private $_ratetype = "";
		...
		*/
		public function SetCustomVars()
		{
			...
			$this->_variables['carriercode'] = array("name" => GetLang('FedExDeliveryTypes'),
			   "type" => "dropdown",
		...
		*/
		...
		private function GetQuote()
		{
			...
			if($netCharge!=0) {
				...
				$quote = new ISC_SHIPPING_QUOTE($this->GetId(), $this->GetDisplayName(), (float)$netCharge, $serviceType);
				return $quote;
			}
			else {
				$Error = true;
