...
<table width="100%" style="background-color:#fff" class="Panel">
	...
	<tr>
		<td width="120" style="padding-left:15px">
			<span class="Required">*</span> %%LNG_USPSDestinationType%%:
		</td>
		<td>
			<select onchange="switch_destination(this.selectedIndex)" name="destination_type" id="destination_type" class="Field250">
				<option value="domestic">%%LNG_USPSDomestic%%</option>
				<option value="international">%%LNG_USPSInternational%%</option>
			</select>
		</td>
	</tr>
</table>

<table id="domestic_delivery_type_table" width="100%" style="margin-top:0px; background-color:#fff" class="Panel">
	<tr>
		<td width="120" style="padding-left:15px">
		...
		<td>
			<select onchange="switch_type(this.selectedIndex)" name="delivery_type" id="delivery_type" class="Field250">
				<option value="EXPRESS">%%LNG_USPSExpressMail%%</option>
				<option value="FIRST CLASS">%%LNG_USPSFirstClass%%</option>
				<option value="PRIORITY">%%LNG_USPSPriorityMail%%</option>
				<option value="PARCEL">%%LNG_USPSParcelPost%%</option>
				<option value="BPM">%%LNG_USPSBPM%%</option>
				<option value="LIBRARY">%%LNG_USPSLibrary%%</option>
				<option value="MEDIA">%%LNG_USPSMedia%%</option>
			</select>
		</td>
	</tr>
</table>

<table id="international_delivery_type_table" width="100%" style="margin-top:0px; background-color:#fff; display: none;" class="Panel">
	<tr>
		<td width="120" style="padding-left:15px">
			<span class="Required">*</span> %%LNG_USPSDeliveryType%%:
		</td>
		<td>
			<select name="intl_delivery_type" id="intl_delivery_type" class="Field250">
				<option value="ExpressMailIntl">%%LNG_USPSExpressMailIntl%%</option>
				<option value="PriorityMailIntl">%%LNG_USPSPriorityMailIntl%%</option>
				<option value="GlobalExpress">%%LNG_USPSGlobalExpress%%</option>
				<option value="FirstClassMailIntl">%%LNG_USPSFirstClassMailIntl%%</option>
			</select>
		</td>
	</tr>
</table>
	...
	<tr>
		...
		<td>
			<select  class='Field250' name='shipping_usps_expressmailpackagesize' id='shipping_usps_expressmailpackagesize'>
				<option value='R'>%%LNG_USPSRegular%%</option>
				<option value='L'>%%LNG_USPSLarge%%</option>
			</select>
		</td>
	</tr>
	<tr>
		<td width="120" style="padding-left:15px">
			&nbsp;&nbsp; %%LNG_USPSContainerType%%:
		</td>
		<td>
			<select  class='Field250' name='shipping_usps_expressmailcontainertype' id='shipping_usps_expressmailcontainertype'>
				<option value=''>%%LNG_USPSCustomContainer%%</option>
				<option value='F'>%%LNG_USPSFlatRateEnvelope%%</option>
			</select>
		</td>
	</tr>
</table>
	...
	<tr>
		...
		<td>
			<select onchange='check_show_girth(this.selectedIndex)' class='Field250' name='shipping_usps_prioritycontainertype' id='shipping_usps_prioritycontainertype'>
				<option value=''>%%LNG_USPSCustomContainer%%</option>
				<option style='display:none' value='R'>%%LNG_USPSRectangular%%</option>
				<option style='display:none' value='N'>%%LNG_USPSNonRectangular%%</option>
				<option value='F' selected>%%LNG_USPSFlatRateEnvelope%%</option>
				<option value='B'>%%LNG_USPSFlatRateBox%%</option>
			</select>
		</td>
	</tr>
	<tr id="priority_width" style="display:none">
		<td width="120" style="padding-left:15px">
			<span class="Required">*</span> %%LNG_USPSWidth%%:
		</td>
		<td>
			<input type='text' class='Field50' name='shipping_usps_prioritywidth' id='shipping_usps_prioritywidth' /> %%GLOBAL_LengthUnit%%
		</td>
	</tr>
	<tr id="priority_length" style="display:none">
		<td width="120" style="padding-left:15px">
			<span class="Required">*</span> %%LNG_USPSLength%%:
		</td>
		<td>
			<input type='text' class='Field50' name='shipping_usps_prioritylength' id='shipping_usps_prioritylength' /> %%GLOBAL_LengthUnit%%
		</td>
	</tr>
	<tr id="priority_height" style="display:none">
		<td width="120" style="padding-left:15px">
			<span class="Required">*</span> %%LNG_USPSHeight%%:
		</td>
		<td>
			<input type='text' class='Field50' name='shipping_usps_priorityheight' id='shipping_usps_priorityheight' /> %%GLOBAL_LengthUnit%%
		</td>
	</tr>
	<tr id="priority_girth" style="display:none">
		<td width="120" style="padding-left:15px">
			<span class="Required">*</span> %%LNG_USPSGirth%%:
		</td>
		<td>
			<input type='text' class='Field50' name='shipping_usps_prioritygirth' id='shipping_usps_prioritygirth' /> %%GLOBAL_LengthUnit%%
		</td>
	</tr>
</table>
	...
	<tr>
		...
		<td>
			<select  class='Field250' name='shipping_usps_parcelpostmachpackagesize' id='shipping_usps_parcelpostmachpackagesize'>
				<option value='R'>%%LNG_USPSRegular%%</option>
				<option value='L'>%%LNG_USPSLarge%%</option>
				<option value='O'>%%LNG_USPSOversize%%</option>
			</select>
		</td>
	</tr>
</table>
...
<table width="100%" style="margin-top:0px; background-color:#fff;" class="Panel">
	<tr id="country_row" style="display: none;">
		<td width="120" style="padding-left:15px">
...
<script type="text/javascript">
	function switch_destination(d) {
		var domestic_table = document.getElementById("domestic_delivery_type_table");
		var international_table = document.getElementById("international_delivery_type_table");

		domestic_table.style.display = "none";
		international_table.style.display = "none";

		switch (d) {
			case 0:
				domestic_table.style.display = "";
				document.getElementById("country_row").style.display = "none";
				switch_type(document.getElementById('delivery_type').selectedIndex);
				break;
			case 1:
				international_table.style.display = "";
