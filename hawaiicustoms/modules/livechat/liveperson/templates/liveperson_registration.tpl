<label style="display: block;"><input type="radio" checked="checked" name="lp_register" onclick="ToggleLivePerson(this.value);" value="1" /> %%LNG_LivePersonDontHaveCreate%%</label>
<div id="lp_register_show">
	<img src="images/nodejoin.gif" alt="" /> <input type="button" value="%%LNG_LivePersonCreateAccount%%" onclick="CreateLivePersonAccount()" class="FormButton" style="width:170px" />
</div>
<label style="display: block;"><input type="radio" name="lp_register" onclick="ToggleLivePerson(this.value);" value="0" /> %%LNG_LivePersonHaveAccount%%</label>
<div style="display: none;" id="lp_existing_show">
	...
	<div style="float: left; padding-top: 5px; padding-left: 10px;">
		%%LNG_LivePersonExistingUserInstructions%%
	</div>
</div>
