                ...
                */
				foreach ($items as $item) {
					...
					if (isset($item['discount_price'])) {
						$coupon_discount += ($item['product_price'] - $item['discount_price']) * $item['quantity']; //* $item['quantity'] Added by Simha to calculate discount for all quantity of the products
					}
					...
					mysql_query("INSERT INTO isc_orderlogs(ordervalue) VALUES ( 'google_item: ".print_r($google_item,true)."')");
