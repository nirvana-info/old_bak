  ...
  */
  ...
  class GoogleResponse {
    ...
    function HttpAuthentication($headers=null, $die=true) {
      ...
      if (isset($_SERVER['REDIRECT_REMOTE_USER']) && (!isset($_SERVER['PHP_AUTH_USER']) && !isset($_SERVER['PHP_AUTH_PW']))) {
  ...
  // the PHP directive cgi.rfc2616_headers must be set to 0 (the default value).
    ...
    function ProcessMerchantCalculations($merchant_calc) {
	  ...
	  //mysql_query("INSERT INTO isc_orderlogs(ordervalue) VALUES ( 'result: ".print_r($result,true)."')");
      echo $result;
    }
