	...
	class CHECKOUT_PAYSIMPLE extends ISC_GENERIC_CREDITCARD
	{
		...
		*/
		public function __construct()
		{
			...
			$this->_liveTransactionURL 	= 'https://www.paysimple.biz';
			$this->_testTransactionURL 	= 'https://sandbox.paysimple1.biz';
			...
			$this->_help = sprintf(GetLang($this->_languagePrefix.'Help'), $GLOBALS['ISC_CFG']["AppPath"].'/modules/paysimple/lib/');	// Help Message
		}
		...
		*/
		...
		public function ProcessPaymentForm()
		{
			...
			try{
				...
				$dynamicKey = new DynamicKey('modules/checkout/paysimple/lib/keyHalf.txt', $gateway);
			...
			$this->_HandleResponse($PSpayment, $message);
		}
