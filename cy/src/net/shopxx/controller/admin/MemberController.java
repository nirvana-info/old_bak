...
public class MemberController extends BaseController {
	...
	public String add(ModelMap model) {
		...
		List<MemberAttribute> memberAttribute = memberAttributeService.findList();
		model.addAttribute("memberAttributes", memberAttribute);
	...
	public String save(Member member, Long memberRankId, HttpServletRequest request, RedirectAttributes redirectAttributes) {
		...
		for (MemberAttribute memberAttribute : memberAttributeService.findList()) {
			...
			} else if (memberAttribute.getType() == Type.sbu) {
				if(request.getParameter("sbuId")!=null)
					member.setSbu(sbuService.find(Long.valueOf(request.getParameter("sbuId"))));
			}
		}
