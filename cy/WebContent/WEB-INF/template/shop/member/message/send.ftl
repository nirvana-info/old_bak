			...
			<div class="input">
				...
				<form id="inputForm" action="send.jhtml" method="post">
					...
					<table class="input">
						<tr>
							<th>
								<span class="requiredField_blue">*</span>${message("shop.member.message.sendTo")}:
							</th>
							<td>
								<label>
						...
						<tr id="receiverTr"[#if draftMessage?? && !draftMessage.receiver??] class="hidden"[/#if]>
							<th>
								<span class="requiredField_blue">*</span>${message("shop.member.message.receiverUsername")}:
							</th>
							<td>
						...
						<tr>
							<th>
								<span class="requiredField_blue">*</span>${message("Message.title")}:
							</th>
							<td>
						...
						<tr>
							<th>
								<span class="requiredField_blue">*</span>${message("Message.content")}:
							</th>
							<td>
