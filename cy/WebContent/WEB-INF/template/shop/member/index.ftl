			...
			<div class="index">
				<div class="top clearfix">
					<div>
						<ul>
							<li>
								${message("shop.member.index.memberRank")}: <span>${member.memberRank.name}</span>
							</li>
							<li>
								${message("shop.member.index.balance")}:
								<strong>${currency(member.balance, true, false)}</strong>
							</li>
							<li>
								${message("shop.member.index.amount")}:
								<strong>${currency(member.amount, true, false)}</strong>
							</li>
							<!--
							<li>
							...
							<tr[#if !order_has_next] class="last"[/#if]>
								...
								<td class="hidden">
									...
									[#elseif order.paymentStatus == "unpaid" || order.paymentStatus == "partialPayment"]
										...
										${message("shop.member.order.waitingApprove")}
