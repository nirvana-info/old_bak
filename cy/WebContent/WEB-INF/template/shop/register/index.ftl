				...
				<div class="main clearfix">
					...
					<form id="registerForm" action="${base}/register/submit.jhtml" method="post">
						<table>
							<tr>
								<th>
									<span class="requiredField_blue">*</span>${message("shop.register.username")}:
								</th>
								<td>
							...
							<tr>
								<th>
									<span class="requiredField_blue">*</span>${message("shop.register.password")}:
								</th>
								<td>
							...
							<tr>
								<th>
									<span class="requiredField_blue">*</span>${message("shop.register.rePassword")}:
								</th>
								<td>
							...
							<tr>
								<th>
									<span class="requiredField_blue">*</span>${message("shop.register.email")}:
								</th>
								<td>
							...
							[@member_attribute_list]
								[#list memberAttributes as memberAttribute]
									<tr>
										<th>
											[#if memberAttribute.isRequired]<span class="requiredField_blue">*</span>[/#if]${memberAttribute.name}:
										</th>
										<td>
											...
											[#elseif memberAttribute.type == "sbu"]
												<select name="sbu">
													<option value="">${message("shop.common.choose")}</option>
													[#list sbus as sbu]
														<option value="${sbu.id}">
							...
							[#if setting.captchaTypes?? && setting.captchaTypes?seq_contains("memberRegister")]
								<tr>
									<th>
										<span class="requiredField_blue">*</span>${message("shop.captcha.name")}:
									</th>
									<td>
										<span class="fieldSet">
