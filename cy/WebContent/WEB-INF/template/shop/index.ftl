...
<body>
	...
	<div class="container index">
		<div class="span24">
			[@ad_position id = 3 /]
			<div class="rightCS floatright">
				<img src="resources/shop/images/customer-service.gif" width="115" height="115" alt="Customer Service" title="Customer Service" />
				<div class="label">Customer Service</div>
				<div class="label">+86 - 4006 760 130</div>
				<div class="label">Monday ~ Friday</div>
				<div class="label">9：30am ~ 6：00pm  GMT+8</div>
				<div class="cs-link"><a href="mailto:david.lee@chengyee.com">e-mail us here</a></div>
			</div>
		</div>
		<!--
