...
<body>
	...
	<ul id="tab" class="tab">
		...
		<li>
			<input type="button" value="${message("admin.order.splitInfo")}" />
		</li>
		<!--
		<li>
		...
		[#if isCombine??]
		<li>
			<input type="button" value="Combined Log" />
		</li>
		[#else]
		[/#if]
		<li>
	...
	<table class="input tabContent">
		<tr>
			...
			<td>
				<input type="button" id="confirmButton" class="button" value="${message("admin.order.confirm")}"[#if order.expired || order.orderStatus != "unconfirmed" || !hasAuthentyApprove] disabled="disabled"[/#if] />
				<!--
				<input type="button" id="paymentButton" class="button" value="${message("admin.order.payment")}"[#if order.expired || order.orderStatus != "confirmed" || (order.paymentStatus != "unpaid" && order.paymentStatus != "partialPayment") || !hasAuthentyApprove] disabled="disabled"[/#if] />
				<input type="button" id="shippingButton" class="button" value="${message("admin.order.shipping")}"[#if order.expired || order.orderStatus != "confirmed" || (order.shippingStatus != "unshipped" && order.shippingStatus != "partialShipment") || !hasAuthentyApprove] disabled="disabled"[/#if] />
				-->
				<input type="button" id="completeButton" class="button" value="${message("admin.order.complete")}"[#if order.expired || order.orderStatus != "confirmed" || !hasAuthentyApprove] disabled="disabled"[/#if] />
			</td>
			<td>
				&nbsp;
			</td>
			<td>
				<!--
				<input type="button" id="refundsButton" class="button" value="${message("admin.order.refunds")}"[#if order.expired || order.orderStatus != "confirmed" || (order.paymentStatus != "paid" && order.paymentStatus != "partialPayment" && order.paymentStatus != "partialRefunds") || !hasAuthentyApprove] disabled="disabled"[/#if] />
				<input type="button" id="returnsButton" class="button" value="${message("admin.order.returns")}"[#if order.expired || order.orderStatus != "confirmed" || (order.shippingStatus != "shipped" && order.shippingStatus != "partialShipment" && order.shippingStatus != "partialReturns") || !hasAuthentyApprove] disabled="disabled"[/#if] />
				-->
				<input type="button" id="cancelButton" class="button" value="${message("admin.order.cancel")}"[#if order.expired || order.orderStatus != "unconfirmed" || !hasAuthentyApprove] disabled="disabled"[/#if] />
			</td>
		</tr>
		<tr>
			<th>
