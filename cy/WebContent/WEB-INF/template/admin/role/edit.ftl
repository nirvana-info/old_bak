			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:specialOrder"[#if role.authorities?seq_contains("admin:specialOrder")] checked="checked"[/#if] />${message("admin.specialOrder")}
						</label>
						<label>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:adminMember"[#if role.authorities?seq_contains("admin:adminMember")] checked="checked"[/#if] />${message("admin.admin.member")}
						</label>
						<label>
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:dict"[#if role.authorities?seq_contains("admin:dict")] checked="checked"[/#if] />${message("admin.dict.dict")}
						</label>
						<label>
