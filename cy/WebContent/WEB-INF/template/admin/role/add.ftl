			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:specialOrder" />${message("admin.specialOrder")}
						</label>
						<label>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:adminMember" />${message("admin.admin.member")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:role" />${message("admin.role.role")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:dict" />${message("admin.dict.dict")}
						</label>
						<label>
