...
<title>${message("admin.admin.member")}</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.admin.member")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="loginDate">${message("admin.admin.member.object")}</a>
				</th>
				<th>
			...
			[#list page.content as admin]
				<tr>
					...
					<td>
						<a href="edit.jhtml?id=${admin.id}">[${message("admin.admin.member.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
