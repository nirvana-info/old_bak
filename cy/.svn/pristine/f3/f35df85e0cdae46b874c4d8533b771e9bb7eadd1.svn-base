...
<title>${message("admin.admin.member.edit")}</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.admin.member.edit")}
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		<input type="hidden" name="id" value="${admin.id}" />
		<ul id="tab" class="tab">
			<li>
				<input type="button" value="${message("admin.admin.member.edit")}" />
			</li>
		</ul>
		<table class="input tabContent">
			...
			<tr class="members">
				<th>
					<span class="requiredField">*</span>${message("admin.admin.member.title")}:
				</th>
				<td>
					<span class="fieldSet">
						[#list members as member]
							<label>
								<input type="checkbox" name="memberIds" value="${member.id}"[#if admin.members?seq_contains(member)] checked="checked"[/#if] />${member.username}
							</label>
						[/#list]
					</span>
				</td>
		...
		<table class="input tabContent hidden">
			<tr>
				<th>
