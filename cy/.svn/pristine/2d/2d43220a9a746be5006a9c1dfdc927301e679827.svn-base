...
public interface OrderService extends BaseService<Order, Long> {
	 ...
	 * @return 商品分页
	 */
	Page<Order> findPage(OrderStatus orderStatus, PaymentStatus paymentStatus, ShippingStatus shippingStatus, Boolean hasExpired, Pageable pageable, Set<Member> members);
     ...
     * 查找合并订单
     */
    List<CombineHis> findCombinePage();
     ...
     * 定时合并订单
     */
    public int combineOrder(Integer startDay, Integer endDay, String startDate2, String endDate2);
  ...
  //获取合并订单集合
  	...
  	//通过日期获取combine_his记录
	CombineHis getCombineHisByModifyDate(String modifyDate);
