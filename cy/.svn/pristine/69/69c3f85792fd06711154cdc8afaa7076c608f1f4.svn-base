	...
	$addGradientPrice.click(function() {
		[@compress single_line = true]
			...
			'<tr>
				...
				<\/td>
				<td>
					<input type="text" name="gradientLists[' + gradientPriceIndex + '].price" class="text memberPrice" maxlength="16" style="width: 50px;" \/>
				<\/td>
				<td>
	...
	<form id="inputForm" action="save.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="volume" class="text" maxlength="9" title="${message("admin.product.volumeTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="leadTime" class="text" maxlength="9" title="${message("admin.product.leadTimeTitle")}" />
				</td>
			</tr>
			<tr>
				<th>
