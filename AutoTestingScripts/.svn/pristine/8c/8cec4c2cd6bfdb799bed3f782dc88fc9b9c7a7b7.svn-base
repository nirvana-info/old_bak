...
namespace SalesLeads360.Task.Register.T007_SaveCount
{

    [TestFixture]

    public class T001_ConsumerLeads_SavedCount : Selectleadstype
    {
        [Test]
        public void T01_Check_ConsumerLeads_EnterZipCode()
        {
            ...
            sc.SavedCount("ConsumerZipCode" + "SavedCountTest" + Date, browser);
        ...
        public void T02_Check_ConsumerLeads_mapradius()
        {
            ...
            sc.SavedCount("ConsumerMapRadius" + "SavedCountTest" + Date,browser);
            browser.Link(Find.ByText("Home")).Click();
        }
        ...
        public void T03_Check_ConsumerLeads_ZipRadius()
        {
            ...
            SaveCount sc = new SaveCount();
            sc.SetDesiredCount(100, browser);
            sc.SavedCount("ConsumerZipRadius" + "SavedCountTest" + Date, browser);
            browser.Link(Find.ByText("Home")).Click();
        }
        ...
        public void T04_Check_ConsumerLeads_selectcity()
        {
            ...
            SaveCount sc = new SaveCount();
            sc.SetDesiredCount(100, browser);
            sc.SavedCount("ConsumerSelectCities" + "SavedCountTest" + Date, browser);
            browser.Link(Find.ByText("Home")).Click();
        }
        ...
        public void T05_Check_ConsumerLeads_selectcounty()
        {
            ...
            SaveCount sc = new SaveCount();
            sc.SetDesiredCount(100, browser);
            sc.SavedCount("ConsumerSelectCounties" + "SavedCountTest" + Date, browser);
            browser.Link(Find.ByText("Home")).Click();
        }
        ...
        public void T06_Check_ConsumerLeads_selectstate()
        {
            ...
            SaveCount sc = new SaveCount();
            sc.SetDesiredCount(100, browser);
            sc.SavedCount("ConsumerSelectStates" + "SavedCountTest" + Date, browser);
            browser.Link(Find.ByText("Home")).Click();
        }
        ...
        public void T07_Check_ConsumerLeads_EnterScfCode()
        {
            ...
            SaveCount sc = new SaveCount();
            sc.SetDesiredCount(100, browser);
            sc.SavedCount("ConsumerSCFCodes" + "SavedCountTest" + Date, browser);
            browser.Link(Find.ByText("Home")).Click();
        }
        ...
        public void T08_Check_ConsumerLeads_upload()
        {
            ...
            SaveCount sc = new SaveCount();
            sc.SetDesiredCount(100, browser);
            sc.SavedCount("ConsumerUploadZips" + "SavedCountTest" + Date,browser);
            browser.Link(Find.ByText("Home")).Click();
        }
    }
}
