...
namespace YinJiaRegressionTestingProject
{
    ...
    public class 采购 : TestBase
    {
        ...
        public void Step06收货()
        {
            ...
            //selenium.Submit("txtBarCode");
            //selenium.Focus("txtBarCode");
            //selenium.Submit("");
         
            //selenium.Click("ctl00_hiddenButton");
            //selenium.FireEvent("aspnetForm", "action");
            //selenium.FireEvent("aspnetForm", "ctl00_hiddenButton");
            selenium.MouseDown("ctl00_hiddenButton");
            selenium.MouseDownRight("ctl00_hiddenButton");
            selenium.Click("aspnetForm");
            selenium.Submit("aspnetForm");
            //selenium.KeyPress("ctl00_hiddenButton","13");
            //selenium.KeyPress("aspnetForm", "13");
            //selenium.KeyDown("aspnetForm", "13");
            selenium.KeyPress("txtBarCode", "13");
            selenium.KeyDown("txtBarCode", "13");
        }
