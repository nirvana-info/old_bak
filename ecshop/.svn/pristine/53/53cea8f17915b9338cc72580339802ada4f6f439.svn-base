...
$_LANG['notice_url'] = 'If this site are the Web site may be the initials for the root directory of the relative address Shopping Mall，Such as index.php；<br>Other circumstances should enter the full URL, such as http://http://www.nirvanainfo.com/';
?>