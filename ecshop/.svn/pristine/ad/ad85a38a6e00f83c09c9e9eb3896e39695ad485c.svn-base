...
$_LANG['notice_url'] = 'If this site are the Web site can be abbreviated as the root directory with the city relative addresses, such asindex.php；<br>Other circumstances should enter the full URL, such ashttp://http://www.nirvanainfo.com/';
